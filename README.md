...
```
## Milestone 5
In this milestone, the play_game() function was created to provide the logic for the game.
- This function defined the word_list and num_lives as parameters
- An instance of the game was created calling the class and then passing the word_list and num_lives as arguments
- A while loop with the body determining whether the user has won, lost or if another input is required
- The function is then called to initiate the game
